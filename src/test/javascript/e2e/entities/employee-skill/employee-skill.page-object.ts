...
export class EmployeeSkillUpdatePage {
  ...
  async taskSelectLastOption(): Promise<void> {
    ...
    await this.taskSelect.all(by.tagName('.ui-multiselect-item')).last().click();
  ...
  async employeeSelectLastOption(): Promise<void> {
    ...
    await this.employeeSelect.all(by.tagName('.ui-dropdown-item')).last().click();
  }
  ...
  async teacherSelectLastOption(): Promise<void> {
    ...
    await this.teacherSelect.all(by.tagName('.ui-dropdown-item')).last().click();
  }
